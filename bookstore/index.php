...
echo '<blockquote>';
	...
	$counter = 0; // Counter variable to keep track of elements in a row
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$counter = 0; // Counter variable to keep track of elements in a row
...
while ($row = $result->fetch_assoc()) {
    ...
    echo '<td>';
    echo '<table>';
    echo '<tr><td><img src="'.$row["Image"].'" width="200" height="200"></td></tr>';
    ...
    echo '<tr><td style="padding: 5px;">Rs.'.$row["Price"].'</td></tr>';
...
// Check if there are remaining elements to close the last row
if ($counter % 5 != 0) {
    // Close the last row
    echo '</tr>';
}
